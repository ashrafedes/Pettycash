...
const FOOTER_LABELS = {
  en: { industries: 'Industries', moreIndustries: 'More Industries', company: 'Company', resources: 'Resources', legal: 'Legal' },
  ar: { industries: 'القطاعات', moreIndustries: 'قطاعات أخرى', company: 'الشركة', resources: 'الموارد', legal: 'قانوني' }
};
