          ...
          <nav class="hidden md:flex items-center gap-1">
            ...
            <div class="relative group">
              ...
              <div class="absolute top-full start-0 mt-1 w-auto bg-white border border-slate-200 rounded-lg shadow-lg p-1 z-50 hidden group-hover:block">
                ...
                <a href="./" class="block px-3 py-2 text-sm font-semibold text-blue-600 hover:bg-blue-50 hover:text-blue-700 rounded-md whitespace-nowrap">Industries</a>
              </div>
            </div>
  ...
  renderFooter() {
    ...
    footer.innerHTML = `
      <div class="max-w-6xl mx-auto px-4 py-8 grid sm:grid-cols-3 gap-6 text-sm text-slate-500">
        <div>
          <h4 class="font-semibold text-slate-700 mb-3">Industries</h4>
          <ul class="space-y-1">
            <li><a href="./construction.html" class="hover:text-blue-600">Construction</a></li>
            <li><a href="./restaurants.html" class="hover:text-blue-600">Restaurants</a></li>
            <li><a href="./clinics.html" class="hover:text-blue-600">Clinics</a></li>
            <li><a href="./schools.html" class="hover:text-blue-600">Schools</a></li>
          </ul>
        </div>
        <div>
          <h4 class="font-semibold text-slate-700 mb-3">More Industries</h4>
          <ul class="space-y-1">
            <li><a href="./ngos.html" class="hover:text-blue-600">NGOs</a></li>
            <li><a href="./retail.html" class="hover:text-blue-600">Retail</a></li>
            <li><a href="./manufacturing.html" class="hover:text-blue-600">Manufacturing</a></li>
            <li><a href="./transportation.html" class="hover:text-blue-600">Transportation</a></li>
          </ul>
        </div>
        <div>
