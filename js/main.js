...
function renderPromoBanner() {
  ...
  banner.innerHTML = isAr
    ? 'تخلص من الورق! <a href="https://pattycashsystem.web.app" target="_blank" rel="noopener noreferrer" class="font-semibold underline hover:text-blue-900 dark:hover:text-blue-100">جرّب نظام Petty Cash</a> لإدارة المصروفات والإيصالات.'
    : 'Go paperless! <a href="https://pattycashsystem.web.app" target="_blank" rel="noopener noreferrer" class="font-semibold underline hover:text-blue-900 dark:hover:text-blue-100">Try the Petty Cash System</a> to manage expenses and receipts.';
